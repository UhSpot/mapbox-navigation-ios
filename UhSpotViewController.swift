...
class UhSpotViewController: UIViewController {
    ...
    @IBOutlet weak var uhspotButton: UIButton!
    @IBOutlet weak var leftSideRegulation: UIButton!
    @IBOutlet weak var rightSideRegulation: UIButton!
    @IBOutlet weak var instructionsBannerView: InstructionsBannerView!
    @IBOutlet weak var currentLegName: UILabel!
    ...
    @objc func progressDidChange(_ notification: NSNotification) {
        ...
        let currentLegName = routeProgress.currentLegProgress.currentStepProgress.step.names?[0]
        if(currentLegName != nil){
            self.currentLegName.text = currentLegName
        }
    ...
    @IBAction func uhspotButtonPressed(_ sender: Any) {
...
extension UhSpotViewController: InstructionsBannerViewDelegate {
...
extension UhSpotViewController: StepsViewControllerDelegate {
