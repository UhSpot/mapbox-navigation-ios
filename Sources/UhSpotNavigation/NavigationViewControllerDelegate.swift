...
public protocol NavigationViewControllerDelegate: VisualInstructionDelegate{
     ...
     */
    func navigationViewControllerDidDismiss(_ navigationViewController: UhSpotNavigationViewController, byCanceling canceled: Bool)
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, didUpdate progress: RouteProgress, with location: CLLocation, rawLocation: CLLocation)
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, willArriveAt waypoint: Waypoint, after remainingTimeInterval: TimeInterval, distance: CLLocationDistance)
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, didArriveAt waypoint: Waypoint) -> Bool
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, shouldRerouteFrom location: CLLocation) -> Bool
    ...
    /**
     ...
     - parameter location: The user’s current location.
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, willRerouteFrom location: CLLocation?)
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, didRerouteAlong route: Route)
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, didFailToRerouteWith error: Error)
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, didRefresh routeProgress: RouteProgress)
    ...
    */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, mainRouteStyleLayerWithIdentifier identifier: String, source: MGLSource) -> MGLStyleLayer?
    ...
    */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, mainRouteCasingStyleLayerWithIdentifier identifier: String, source: MGLSource) -> MGLStyleLayer?
    ...
    */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, alternativeRouteStyleLayerWithIdentifier identifier: String, source: MGLSource) -> MGLStyleLayer?
    ...
    */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, alternativeRouteCasingStyleLayerWithIdentifier identifier: String, source: MGLSource) -> MGLStyleLayer?
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, shapeFor routes: [Route]) -> MGLShape?
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, simplifiedShapeFor route: Route) -> MGLShape?
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, waypointStyleLayerWithIdentifier identifier: String, source: MGLSource) -> MGLStyleLayer?
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, waypointSymbolStyleLayerWithIdentifier identifier: String, source: MGLSource) -> MGLStyleLayer?
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, shapeFor waypoints: [Waypoint], legIndex: Int) -> MGLShape?
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, didSelect route: Route)
    
    /**
     Returns the center point of the user course view in screen coordinates relative to the map view.
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, mapViewUserAnchorPoint mapView: NavigationMapView) -> CGPoint
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, shouldDiscard location: CLLocation) -> Bool
     ...
     */
    func navigationViewController(_ navigationViewController: UhSpotNavigationViewController, roadNameAt location: CLLocation) -> String?
}
